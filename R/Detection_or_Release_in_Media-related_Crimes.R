...
ynA <- read.csv("../excelNgraph_img/경찰청_성폭력범죄 범죄자 구속 불구속 현황_20211231.csv", header = T, fileEncoding = "euc-kr")
...
ggplot(data=ynA_data_clean, aes(x = unArrest, y = Arrest, color = year)) +
  geom_point(size = 3) + 
  ggtitle("통신매체 구속 불구속") + 
